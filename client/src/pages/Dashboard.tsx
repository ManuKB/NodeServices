    ...
    <div className="space-y-5 sm:space-y-6">
      <div className="flex items-center justify-between">
        ...
        <select
          ...
          className="px-3 py-2 border border-gray-300 rounded-lg focus-ring-primary outline-none text-sm"
        >
          {[...Array(5)].map((_, i) => {
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 animate-fade-in-up stagger-1">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 animate-fade-in-up stagger-2">
          <div className="flex items-center gap-3">
            <div className="bg-secondary-light p-3 rounded-lg">
              <TrendingUp size={24} className="text-secondary" />
            </div>
            <div>
              <p className="text-xs sm:text-sm text-gray-500">Yearly Total ({year})</p>
              <p className="text-xl sm:text-2xl font-bold text-gray-900">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 animate-fade-in-up stagger-3">
          <div className="flex items-center gap-3">
            <div className="bg-amber-100 p-3 rounded-lg">
              <Calendar size={24} className="text-amber-600" />
            </div>
            <div>
              <p className="text-xs sm:text-sm text-gray-500">Avg Monthly ({year})</p>
              <p className="text-xl sm:text-2xl font-bold text-gray-900">
      ...
      {/* Monthly trend chart */}
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 animate-fade-in-up stagger-4">
        <h2 className="text-base sm:text-lg font-semibold text-gray-900 mb-4">Monthly Expense Trend ({year})</h2>
        <div className="h-56 sm:h-80">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={chartData} margin={{ top: 5, right: 10, left: 0, bottom: 5 }}>
              <CartesianGrid strokeDasharray="3 3" stroke="#f0f0f0" />
              <XAxis dataKey="name" tick={{ fill: '#6b7280', fontSize: 12 }} />
              <YAxis tick={{ fill: '#6b7280', fontSize: 12 }} width={50} />
              <Tooltip
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 animate-fade-in-up stagger-5">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-base sm:text-lg font-semibold text-gray-900">
            Current Month ({currentMonthExpenses.length})
          </h2>
          <Link
            to="/expenses"
            className="text-primary hover-text-primary text-sm font-medium flex items-center gap-1 btn-press"
          >
          ...
          <>
            ...
            <div className="sm:hidden space-y-3">
              {currentMonthExpenses.slice(0, 5).map((expense) => (
                <div key={expense.id} className="expense-card animate-fade-in-up">
